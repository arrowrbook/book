...
We can see that this returns a data frame with one row per PUMA and language, with the number of speakers and the proportion of primarily non-English speakers compared to the overall population.
...
#| echo: false
#| fig-height: 7
#| fig-cap: "Proportion of primarily non-English speakers by language across the US by PUMA for German, French, Navajo, and Spanish"
plot
```
:::
...
#| echo: false
#| fig-height: 5
#| fig-cap: "Proportion of primarily non-English speakers by language in the Chicago by PUMA for Chinese, Polish, and Spanish"
plot +
  scale_x_continuous(
...
#| echo: false
#| fig-height: 9
#| fig-cap: "Proportion of primarily non-English speakers by language in the Northeast by PUMA for Chinese, French, Portuguese, and Spanish"
