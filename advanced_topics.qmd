...
This is going to be very very close to the actual weighted means since this data was used to fit this linear model.
...
And we can visualize the underlying data along with weighted mean and predictions.
...
We can also re-use this UDF for any subset, including predicting on all of the US in 2021.
