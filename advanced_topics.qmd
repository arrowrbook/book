...
Here the underlying data is represented in teh density curve --- the taller the curve the more observations are at that point on the x-axis (hours worked per week). 
...
And we can see the fit is slightly better, though we still slightly over predict particularly self-employed workers.
