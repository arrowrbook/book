...
We can use this model to predict what our model would have on this data.
We use the `predict` function to make these predictions and we also calculate the weighted mean for each group.
This is going to be very close to the actual weighted means since this data was used to fit this linear model.
