...
We can see that this returns a data frame with one row per PUMA and language, with the number of speakers and the proportion of non-English speakers compared to the overall population.
