...
read_csv_arrow(
  "./data/raw_csvs/person/2021/ak/psam_p02.csv",
  schema = pums_csv_one_state_schema,
  skip = 1
)
```
...
write_csv_arrow(
  pums_subset,
  "./data/transient_data/new_pums.csv"
)
```
...
write_csv_arrow(
  numeric_table,
  "./data/transient_data/numeric.csv"
)

write_parquet(
  numeric_table,
  "./data/transient_data/numeric.parquet"
)
```
...
read_parquet(wa_21_path, as_data_frame = FALSE) |>
  write_parquet(
    "./data/transient_data/pums_subset_no_dict.parquet",
