...
![Dataset components](images/excalidraw/datasets_dataset_bw.png){width="100%"}
:::
...
![Folder and file structure of a partitioned dataset](images/excalidraw/datasets_pums.png){width="70%"}
:::

::: {.content-hidden when-format="html"}
![Folder and file structure of a partitioned dataset](images/excalidraw/datasets_pums_bw.png){height="70%"}
:::
...
::: {.content-visible when-format="html"}
| Dataset                   | # of Files | Min size (MB) | 1st Quartile (MB) | Median size (MB) | 3rd Quartile (MB) | Max size (MB) |
|---------------------------|-----------:|--------------:|------------------:|-----------------:|------------------:|--------------:|
| pums_one_big_file          |          1 |        7786.3 |            7786.3 |           7786.3 |            7786.3 |        7786.3 |
| pums_by_year               |         34 |           0.1 |               0.1 |            211.8 |             459.9 |          493  |
| pums_by_year_location      |       1785 |           0.1 |               0.1 |              0.1 |              6.02 |         56.1  |
| pums_by_year_location_age  |      14124 |           0.1 |               0.1 |              0.4 |              1.09 |         17.6  |
...
::: {.content-visible when-format="pdf"}
| Dataset                   | # of Files | Min size (MB) | Median size (MB) | Max size (MB) |
|---------------------------|-----------:|--------------:|-----------------:|--------------:|
| pums_one_big_file          |          1 |        7786.3 |           7786.3 |        7786.3 |
| pums_by_year               |         34 |           0.1 |            211.8 |          493  |
| pums_by_year_location      |       1785 |           0.1 |              0.1 |         56.1  |
| pums_by_year_location_age  |      14124 |           0.1 |              0.4 |         17.6  |
...
### Combining datasets {#sec-combining-datasets}
